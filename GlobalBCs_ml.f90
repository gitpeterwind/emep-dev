...
!hf
  ...
  integer, public, parameter ::  NGLOB_BC  = 17 ! No. species setup here
!hf err  integer, public, parameter ::  NGLOB_BC  = 18 ! No. species setup here
...
!hf err  SpecBC(IBC_OH   ) = sineconc(-99.9 ,-99.9,-99.9,-99.9 ,-99.9,1.0e-7*PPB,1.) !dsOH
...
!hf err           case  ( IBC_OH)
!hf err                write(unit=fname,fmt="(a6,i2.2)") "D3_OH.",month
!hf err               call open_file(IO_GLOBBC,"r",fname,needed=.true.)
!hf err             if ( ios /= 0 ) errmsg = "BC Error H2O2"
!hf err
!hf err             read(IO_GLOBBC,*) bc_rawdata
!hfOH              conv_factor=1.0
!hf err             close(IO_GLOBBC)
