...
!pw 15/3-2005 We assume BC defined in large domain:
         IGLOB = IILARDOM, &     ! number of large domain grids cells, longitude
         JGLOB = JJLARDOM        ! number of large domain grids cells, latitude
...
!               ,     33.9 ,     34.2 ,     35.3,      39.3 ,     40.5 ,     42.3 /)
  macehead_O3 = (/  39.8 ,     40.1 ,     44.7 ,     45.4 ,     45.7 ,     41.7 &
           ...
           Raw  ( N)    Used
Month  1   40.1 (13)     39.8
Month  2   40.1 (12)     40.1
Month  3   45.6 (10)     44.7
Month  4   49.8 ( 5)     45.4
Month  5   46.0 (14)     45.7
Month  6   41.7 (15)     41.7
Month  7   33.3 (17)     33.3
Month  8   31.1 (13)     31.0
Month  9   36.1 (13)     35.7
Month 10   38.2 (12)     37.9
Month 11   40.9 (17)     40.9
Month 12   38.4 ( 8)     38.1
