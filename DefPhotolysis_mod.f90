...
!-------------------------------------------------------------------------------
  ...
  module DefPhotolysis_mod
    ...
    !-------------------------------------------------------------------------------
      ...
      ! copy of EmChem19 definitions matching CloudJ indices from CloudJ_EmChem19 input folder/file,
      ! for situational use with different EmChem19 versions generated by GenChem; otherwise identical
      integer, public, parameter :: &
      IDO3_O3P_c  = CLJ3 , IDO3_O1D_c = CLJ4 , IDNO2_c    = CLJ9 , IDHCHO_H_c = CLJ5 , &
      IDHCHO_H2_c = CLJ6 , IDH2O2_c   = CLJ7 , IDCH3O2H_c = CLJ8 , IDNO3_c    = CLJ74, &
      IDHO2NO2_c  = CLJ16, IDRCOCHO_c = CLJ64, IDCH3COY_c = CLJ72, IDMEK_c    = CLJ75, &
      IDCH3CHO_c  = CLJ54, IDGLYOXA_c = CLJ65, IDGLYOXB_c = CLJ66, IDGLYOXC_c = CLJ67, &
      IDPAN_c     = CLJ52, IDHNO3_c   = CLJ15, IDHONO_c   = CLJ14, IDCHOCHO_c = CLJ73, &
      IDNO3_NO_c  = CLJ11, IDNO3_NO2_c= CLJ12, IDACETON_c = CLJ68, IDN2O5_c   = CLJ13
