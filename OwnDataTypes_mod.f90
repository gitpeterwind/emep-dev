...
!default values for sources:
   ...
   character(len=TXTLEN_NAME) :: country_ISO_excl(601) = 'NOTSET' ! Exclude those countries
   character(len=TXTLEN_NAME) :: country_ISO_incl(601) = 'NOTSET' ! If set, include only those countries
