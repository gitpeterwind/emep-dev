...
module ChemRates_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemRates = " EmChem09 ShipNOx VBS_acp2012 FFireInert SeaSalt DustExtended Pollen"
...
contains
  ...
  subroutine setChemRates()
    ...
    rct(71,:) = (IUPAC_TROE(7.4e-31*EXP(2.4*(LOG(300/TEMP))),  &
              ...
              & M,  &
              & 0.75+3.884e-4*TEMP))
    rct(72,:) = (((3.2e-30*M*(TEMP/300)**(-4.5))*(3.0e-11))  &
