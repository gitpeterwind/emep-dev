...
! time-res: M -> monthly, D-> daily....
  ...
  ! some shorthands for this table
   ...
   type(typ_s5i), public, parameter, dimension(45) :: &
      OutputConcs = (/  &
       ! ppb
...
!SR     ,typ_s5i("Snow_m    ", "m",   D2,"SNOW     ","MISC", D)&
!SR     ,typ_s5i("SURF_ppbC_VOC  ", "ppb", D2,"VOC      ","MISC", D)&!?CHECK??
!SR     ,typ_s5i("SMI_deep  ", "-",   D2,"SMI_deep ","MISC", D)&
!SR     ,typ_s5i("SMI_uppr  ", "-",   D2,"SMI_uppr ","MISC", D)&
...
!     dimension( size(DDEP_SPECS)*size(DDEP_ECOS) ), save :: OutDDep
   ...
   ! dep. velocities for in netcdf files. Set in My_DryDep_ml.
    ...
    !SR type(typ_s5i), public, parameter, dimension(17) :: &
    type(typ_s5i), public, parameter, dimension(1) :: &
         NewMosaic = (/ &
             typ_s5i( "Mosaic", "VG", "O3       ", "Grid","cms",D ) &
!SR          ,typ_s5i( "Mosaic", "VG", "O3       ", "CF  ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "O3       ", "SNL ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "HNO3     ", "Grid","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "HNO3     ", "W   ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "HNO3     ", "CF  ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "HNO3     ", "SNL ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "NO3_F    ", "SNL ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "NO3_C    ", "SNL ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "NO3_F    ", "Grid","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "NO3_C    ", "Grid","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "SEASALT_F", "W   ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "SEASALT_C", "W   ","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "SEASALT_F", "Grid","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "VG", "SEASALT_C", "Grid","cms",D ) &
!SR         ,typ_s5i( "Mosaic", "Rs", "SO2      ", "Grid","sm",D ) &
!SR         ,typ_s5i( "Mosaic", "Rs", "NH3      ", "Grid","sm",D ) &
         /)
...
!----------------------
   ...
   type(typ_s3), dimension(6), public, parameter :: WDEP_WANTED = (/ &
         typ_s3( "PREC     ", "PREC ", "mm  " )  &
