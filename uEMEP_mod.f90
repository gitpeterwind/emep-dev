                 ...
                 do i=1,limax
                    ...
                    do dy=-uEMEP%dist,uEMEP%dist
                       do dx=-uEMEP%dist,uEMEP%dist
                          ...
                          if(isec==0.and.k==KMAX_MID)fracsum(i,j)=fracsum(i,j)+loc_frac_hour_inst(dx,dy,i,j,k,isec_poll)
                       enddo
                    enddo
                 enddo
              enddo
                 ...
                 do i=1,limax
                    ...
                    do dy=-uEMEP%dist,uEMEP%dist
                       do dx=-uEMEP%dist,uEMEP%dist
                          ...
                          if(isec==0.and.k==KMAX_MID)fracsum(i,j)=fracsum(i,j)+loc_frac_hour(dx,dy,i,j,k,isec_poll)
                       enddo
                    enddo
                 enddo
              enddo
                 ...
                 do i=1,limax
                    ...
                    do dy=-uEMEP%dist,uEMEP%dist
                       do dx=-uEMEP%dist,uEMEP%dist
                          ...
                          if(isec==0.and.k==KMAX_MID)fracsum(i,j)=fracsum(i,j)+loc_frac_day(dx,dy,i,j,k,isec_poll)
                       enddo
                    enddo
                 enddo
              enddo
                 ...
                 do i=1,limax
                    ...
                    do dy=-uEMEP%dist,uEMEP%dist
                       do dx=-uEMEP%dist,uEMEP%dist
                          ...
                          if(isec==0.and.k==KMAX_MID)fracsum(i,j)=fracsum(i,j)+loc_frac_month(dx,dy,i,j,k,isec_poll)
                       enddo
                    enddo
                 enddo
              enddo
                 ...
                 do i=1,limax
                    ...
                    do dy=-uEMEP%dist,uEMEP%dist
                       do dx=-uEMEP%dist,uEMEP%dist
                         ...
                         if(isec==0.and.k==KMAX_MID)fracsum(i,j)=fracsum(i,j)+loc_frac_full(dx,dy,i,j,k,isec_poll)
                       enddo
                    enddo
                 enddo
              enddo
