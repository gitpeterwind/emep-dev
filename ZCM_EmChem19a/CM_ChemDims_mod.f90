...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem19a PM_VBS_EmChem19 BVOC_IsoMT1_emis Aqueous_EmChem16x Aero2017nx ShipNOx FFireInert SeaSalt DustExtended Ash PM_WoodFFuelInert BVOC_SQT_NV"
    ...
    integer, public, parameter :: NSPEC_ADV=113
