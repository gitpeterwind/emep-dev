...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChem19a PM_VBS_EmChem19 BVOC_IsoMT1_emis Aqueous_EmChem16x Aero2017nx ShipNOx FFireInert SeaSalt DustExtended Ash PM_WoodFFuelInert BVOC_SQT_NV"
  ...
  integer, public, parameter :: &
      IXADV_Ash_c       = 101  &
    , IXADV_POM_f_wood  = 102  &
    , IXADV_POM_c_wood  = 103  &
    , IXADV_POM_f_ffuel = 104  &
    , IXADV_POM_c_ffuel = 105  &
    , IXADV_EC_f_wood_new= 106  &
    , IXADV_EC_f_wood_age= 107  &
    , IXADV_EC_c_wood   = 108  &
    , IXADV_EC_f_ffuel_new= 109  &
    , IXADV_EC_f_ffuel_age= 110
  
  integer, public, parameter :: &
      IXADV_EC_c_ffuel  = 111  &
    , IXADV_pSO4f       = 112  &
    , IXADV_pSO4c       = 113  &
    , IXADV_remPPM25    = 114  &
    , IXADV_remPPM_c    = 115
