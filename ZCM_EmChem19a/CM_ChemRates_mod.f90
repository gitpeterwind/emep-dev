...
module ChemRates_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemRates = " EmChem19a VBS_EmChem19 APINENE_BVOC_emis BVOC_EmChem19 Aqueous_EmChem16x Aero2017nx Ash_EmChem16z ShipNOx16z FFireInert16z SeaSalt16z DustExtended16z Pollen"
...
contains
  ...
  subroutine setChemRates()
    ...
    rct(76,:) = 8.22e-16*EXP(-640.0*TINV)
    ...
    rct(95,:) = 7.5e-13*EXP(700.0*TINV)
    rct(96,:) = 3.8e-12*EXP(200.0*TINV)
