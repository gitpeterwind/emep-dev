...
module ChemRates_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemRates = " EmChem19a VBS_EmChem19 APINENE_BVOC_emis BVOC_EmChem19 Aqueous_EmChem16x Aero2017nx Ash ShipNOx FFireInert SeaSalt DustExtended Pollen"
...
contains
  ...
  subroutine setChemRates()
    ...
    rct(61,:) = (1.4e-12*EXP(-1860.0*TINV))*5.5
