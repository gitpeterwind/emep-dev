...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChem19 VBS_EmChem16z APINENE_BVOC_emis BVOC_EmChem16z Aqueous_EmChem16x Aero2017nx Ash_EmChem16z ShipNOx16z FFireInert16z SeaSalt16z DustExtended16z Pollen"
  ...
  integer, public, parameter :: &
    ...
    , IXADV_Dust_sah_f  =  67  &
    , IXADV_Dust_sah_c  =  68  &
    , IXADV_POLLEN_BIRCH=  69  &
    , IXADV_POLLEN_OLIVE=  70
  
  integer, public, parameter :: &
      IXADV_POLLEN_RWEED=  71  &
    , IXADV_POLLEN_GRASS=  72  &
    , IXADV_ASOC_ng1e2  =  73  &
    , IXADV_ASOC_ug1    =  74  &
    , IXADV_ASOC_ug10   =  75  &
    , IXADV_ASOC_ug1e2  =  76  &
