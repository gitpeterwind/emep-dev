...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem19 VBS_EmChem19 APINENE_BVOC_emis BVOC_EmChem19 Aqueous_EmChem16x Aero2017nx Ash ShipNOx FFireInert SeaSalt DustExtended Pollen"
