...
! scheme(s)  EmChem09 ShipNOx VBS_acp2012 FFireInert SeaSalt DustExtended
module ChemGroups_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemGroups = " EmChem09 ShipNOx VBS_acp2012 FFireInert SeaSalt DustExtended"
  
  
  ! Assignment of groups from GenIn_Species.csv
  public :: Init_ChemGroups
  
  type(typ_sp), dimension(135), public, save :: chemgroups
