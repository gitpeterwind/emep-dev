...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem09 VBS_acp2012 APINENE_BVOC_emis BVOC_EmChem19 Aqueous_EmChem16x Aero2017nx Ash ShipNOx FFireInert SeaSalt DustExtended Pollen"
    ...
    integer, public, parameter :: NDRYDEP_ADV = 71
    
    ! No. WET deposition species
    integer, public, parameter :: NWETDEP_ADV = 63
    ...
    ! No. emission Specss
    integer, parameter, public :: NEMIS_Specs = 45
