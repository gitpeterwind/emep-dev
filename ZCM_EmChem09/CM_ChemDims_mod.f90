...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem09 VBS_acp2012 ShipNOx FFireInert SeaSalt DustExtended Pollen"
    ...
    ! No. emission Specss
    integer, parameter, public :: NEMIS_Specs = 46
