...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChem09 VBS_acp2012 FFireInert SeaSalt DustExtended"
  ...
  integer, public, parameter :: &
    ...
    , IXADV_CH4         =  87  &
    , IXADV_POM_f_WOOD  =  88  &
    , IXADV_POM_f_FFUEL =  89  &
    , IXADV_POM_c_FFUEL =  90
  
  integer, public, parameter :: &
      IXADV_EC_f_WOOD_new=  91  &
    , IXADV_EC_f_WOOD_age=  92  &
    , IXADV_EC_c_WOOD   =  93  &
    , IXADV_EC_f_FFUEL_new=  94  &
    , IXADV_EC_f_FFUEL_age=  95  &
    , IXADV_EC_c_FFUEL  =  96  &
    , IXADV_REMPPM25    =  97  &
    , IXADV_REMPPM_c    =  98  &
    , IXADV_OM25_BGND   =  99  &
