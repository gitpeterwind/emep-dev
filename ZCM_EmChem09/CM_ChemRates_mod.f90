...
module ChemRates_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemRates = " EmChem09 VBS_acp2012 ShipNOx FFireInert SeaSalt DustExtended Pollen"
...
contains
  ...
  subroutine setChemRates()
    ...
    rct(93,:) = (((3.2e-30*M*(TEMP/300)**(-4.5))*(3.0e-11))  &
