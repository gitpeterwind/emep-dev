...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChem19c PM_VBS_EmChem19 Aqueous_EmChem16x Aero2017nx ShipNOx PM_FFireInert SeaSalt DustExtended Ash PM_ResNonResInert BVOC_SQT_NV BVOC_IsoMT1_emis"
  ...
  integer, public, parameter :: &
      IXADV_non_C_ASOA_ug1e3=  61  &
    , IXADV_non_C_ASOA_ug1e2=  62  &
    , IXADV_non_C_ASOA_ug10=  63  &
    , IXADV_non_C_ASOA_ug1=  64  &
    , IXADV_non_C_ASOA_ng1e2=  65  &
    , IXADV_BSOC_ug1e3  =  66  &
    , IXADV_BSOC_ug1e2  =  67  &
    , IXADV_BSOC_ug10   =  68  &
    , IXADV_BSOC_ug1    =  69  &
  ...
  integer, public, parameter :: &
      IXADV_non_C_BSOA_ug1e3=  71  &
    , IXADV_non_C_BSOA_ug1e2=  72  &
    , IXADV_non_C_BSOA_ug10=  73  &
    , IXADV_non_C_BSOA_ug1=  74  &
    , IXADV_non_C_BSOA_ng1e2=  75  &
    , IXADV_SO4         =  76  &
    , IXADV_NH3         =  77  &
    , IXADV_NO3_f       =  78  &
    , IXADV_NO3_c       =  79  &
  ...
  integer, public, parameter :: &
    ...
    , IXADV_ffire_OM    =  83  &
    , IXADV_ffire_BC    =  84  &
    , IXADV_ffire_remPPM25=  85  &
    , IXADV_ffire_c     =  86  &
    , IXADV_SeaSalt_f   =  87  &
    , IXADV_SeaSalt_c   =  88  &
    , IXADV_Dust_road_f =  89  &
    , IXADV_Dust_road_c =  90
  ...
  integer, public, parameter :: &
    ...
    , IXADV_POM_f_Res   =  97  &
    , IXADV_POM_c_Res   =  98  &
    , IXADV_POM_f_nonRes=  99  &
    , IXADV_POM_c_nonRes= 100
  
  integer, public, parameter :: &
      IXADV_EC_f_Res_new= 101  &
    , IXADV_EC_f_Res_age= 102  &
    , IXADV_EC_c_Res    = 103  &
    , IXADV_EC_f_nonRes_new= 104  &
    , IXADV_EC_f_nonRes_age= 105  &
    , IXADV_EC_c_nonRes = 106  &
    , IXADV_remPPM25_nonRes= 107  &
    , IXADV_remPPM25_Res= 108  &
    , IXADV_remPPM_c_nonRes= 109  &
    , IXADV_remPPM_c_Res= 110
  
  integer, public, parameter :: &
      IXADV_SQT_SOA_NV  = 111
  ...
  integer, public, parameter :: FIRST_SEMIVOL=71, &
                                 LAST_SEMIVOL=90
