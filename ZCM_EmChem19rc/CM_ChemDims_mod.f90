...
module ChemDims_mod
  ...
  implicit none
  character(len=*),parameter, public :: CM_schemes_ChemDims = " EmChem19cj PM_VBS_EmChem19 Aqueous_EmChem16x Aero2017nx ShipNOx PM_FFireInert SeaSalt DustExtended Ash PM_ResNonResInert BVOC_SQT_NV BVOC_IsoMT1_emis"
  

    ! NSPEC for TOT : All reacting species
    integer, public, parameter :: NSPEC_TOT=126
    ...
    ! No. emission Specss
    integer, parameter, public :: NEMIS_Specs = 50
