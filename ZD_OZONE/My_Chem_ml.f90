...
!/ ...... ..   ( from GenChem )
  ...
  contains
    ...
    !
       ...
       species( 11) = Chemical("OXYO2       ",   1,  0,  0,   0,  0 ) 
       ...
       species( 23) = Chemical("ISONO3      ", 110,  0,  0,   1,  1 ) 
       ...
       species( 28) = Chemical("ISNI        ",  46,  0,  0,   1,  1 ) 
       species( 29) = Chemical("ISNIR       ",  46,  0,  0,   1,  1 ) 
       ...
       species( 48) = Chemical("OXYO2H      ",   1,  0,  0,   0,  0 ) 
       species( 49) = Chemical("MEKO2H      ", 104,  0,  4,   0,  0 ) 
       species( 50) = Chemical("MALO2H      ", 147,  0,  5,   0,  0 ) 
       species( 51) = Chemical("MVKO2H      ",   1,  0,  0,   0,  0 ) 
       species( 52) = Chemical("MARO2H      ",   1,  0,  0,   0,  0 ) 
       species( 53) = Chemical("ISRO2H      ",   1,  0,  0,   0,  0 ) 
       species( 54) = Chemical("H2O2        ",  34,  0,  0,   0,  0 ) 
       species( 55) = Chemical("CH3COO2H    ",  76,  0,  2,   0,  0 ) 
       species( 56) = Chemical("CH2CO2HCH3  ",  74,  0,  3,   0,  0 ) 
       species( 57) = Chemical("ISONO3H     ",   1,  0,  0,   0,  0 ) 
       species( 58) = Chemical("ISNIRH      ",   1,  0,  0,   0,  0 ) 
