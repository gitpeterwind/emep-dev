...
!_____________________________________________________________________________
  ...
  use GenSpec_adv_ml  !DSGC, only: NSPEC_ADV & 
!DSGC                 ,IXADV_H2,IXADV_O3, IXADV_SO2, IXADV_SO4  &
!DSGC                 ,IXADV_HNO3,IXADV_PAN,IXADV_CO,IXADV_C2H4  &
!DSGC                 ,IXADV_C2H6,IXADV_NC4H10,IXADV_HCHO,IXADV_CH3CHO   &
!DSGC                 ,IXADV_H2O2,IXADV_CH3O2H,IXADV_ISOP,IXADV_NO,IXADV_NO2  &
!DSGC                 ,IXADV_CH4,IXADV_aNH4,IXADV_pNO3,IXADV_aNO3 &
!DSGC                 ,IXADV_CH3COO2
...
!DSGC  bc2xn_adv(IBC_SO2     ,IXADV_SO2     )   =   1.0
!DSGC  bc2xn_adv(IBC_SO4     ,IXADV_SO4    )   =   1.0
!DSGC  bc2xn_adv(IBC_PAN     ,IXADV_PAN     )   =   1.0
!DSGC  bc2xn_adv(IBC_CO      ,IXADV_CO      )   =   1.0
!DSGC  bc2xn_adv(IBC_C2H6    ,IXADV_C2H6    )   =   1.0
!DSGC  bc2xn_adv(IBC_C4H10   ,IXADV_NC4H10  )   =   1.0
!DSGC  bc2xn_adv(IBC_NO      ,IXADV_NO      )   =   1.0
!DSGC  bc2xn_adv(IBC_NO2     ,IXADV_NO2     )   =   1.0
!DSGC  bc2xn_adv(IBC_HCHO    ,IXADV_HCHO    )   =   1.0
!DSGC  bc2xn_adv(IBC_CH3CHO  ,IXADV_CH3CHO  )   =   1.0
!DSGC  bc2xn_adv(IBC_aNO3    ,IXADV_aNO3    )   =   1.0
!DSGC  bc2xn_adv(IBC_pNO3    ,IXADV_pNO3    )   =   1.0
!DSGC  bc2xn_adv(IBC_aNH4    ,IXADV_aNH4    )   =   1.0
!DSGC!hfOH NEW: When a smaller domain than the full, there are BCs for these from OZONE  
!DSGC!hf err  bc2xn_bgn(IBC_H2O2    ,IXADV_H2O2    )   =   1.0!hfOH
!DSGC!hf err   bc2xn_bgn(IBC_CH3COO2 ,IXADV_CH3COO2 )   =   1.0 !hfOH
!DSGC!hf err   bc2xn_bgn(IBC_OH      ,IXSHL_OH    )   =   1.0 !hfOH 
!DSGC  bc2xn_adv(IBC_H2O2    ,IXADV_H2O2    )   =   1.0!hfOH
!DSGC  bc2xn_adv(IBC_CH3COO2 ,IXADV_CH3COO2 )   =   1.0 !hfOH
!DSGC
!DSGC
!DSGC! The following species are excluded either because they have no corresponding
!DSGC! species in the emep model, or because they have lifetimes which are so
!DSGC! short that initialisation is uncessary.
!DSGC!-----------------------------------------------------------------------------
!DSGC!u3  bc2xn_adv(IBC_C2H4    ,IXADV_C2H4  )   =   1.0
!DSGC!u3  bc2xn_adv(IBC_C3H6    ,IXADV_NC4H10  )   =   0.75
!DSGC!u3  bc2xn_adv(IBC_C6H14   ,IXADV_NC4H10  )   =   1.5   ! ds - scale by C6/C4
!DSGC!u3  bc2xn_adv(IBC_CH2O    ,IXADV_HCHO    )   =   1.0   ! ds -rename
!DSGC!u3  bc2xn_adv(IBC_CH3CHO  ,IXADV_CH3CHO  )   =   1.0
!DSGC!u3  bc2xn_adv(IBC_H2O2    ,IXADV_H2O2    )   =   1.0
!DSGC!u3  bc2xn_adv(IBC_CH3O2H  ,IXADV_CH3O2H  )   =   1.0
!DSGC!u3  bc2xn_adv(IBC_ISOPRENE,IXADV_ISOP    )   =   1.0   ! ds-rename
!DSGC!u3  bc2xn_adv(IBC_RCOHCO  ,IXADV_CH3CHO  )   =   1.0   ! ds - unknown scale
!DSGC!u3  bc2xn_adv(IBC_CH4     ,IXADV_CH4     )   =   1.0   ! Re-included for DSMACH
!DSGC!u3  bc2xn_adv(IBC_C3H8    ,IXADV_NC4H10 )   =   0.75   ! mini
!DSGC!u3  bc2xn_adv(IBC_C3H8    ,IXADV_NC4H10  )   =   0.5   ! ds-split C2H6/NC4H10
!DSGC!!bc2xn_adv(IBC_NOX ,IXADV_NOX     )   =  -1.0   ! Excluded, we have NO and NO2
!DSGC!!bc2xn_adv(IBC_C6HXR   ,IXADV_C6HXR   )   =   1.0
!DSGC!!bc2xn_adv(IBC_HO2NO2  ,IXADV_HO2NO2  )   =   1.0
!DSGC!!bc2xn_adv(IBC_CH3COY  ,IXADV_CH3COY  )   =   1.0
!DSGC!!bc2xn_adv(IBC_CH3COX  ,IXADV_CH3COX  )   =   1.0
!DSGC!!bc2xn_adv(IBC_HO2     ,IXADV_HO2     )   =  -1.0   ! SHort-lived
!DSGC!!bc2xn_adv(IBC_CH2O2OH ,IXADV_CH2O2OH )   =   1.0
!DSGC!!bc2xn_adv(IBC_CH3COB  ,IXADV_CH3COB  )   =  -1.0   ! ???
!DSGC!!bc2xn_adv(IBC_CH3XX   ,IXADV_CH3XX   )   =   1.0
!DSGC!!bc2xn_adv(IBC_AR1     ,IXADV_AR1     )   =  -1.0   ! ???
!DSGC!!bc2xn_adv(IBC_AR2     ,IXADV_AR2     )   =   1.0
!DSGC!!bc2xn_adv(IBC_AR3     ,IXADV_AR3     )   =  -1.0   ! ???
!DSGC!!bc2xn_adv(IBC_ISOR1   ,IXADV_ISOR1   )   =  -1.0   ! Re-Excluded
!DSGC!!bc2xn_adv(IBC_ISOK    ,IXADV_ISOK    )   =  -1.0   ! ??
!DSGC!!bc2xn_adv(IBC_ISOR2   ,IXADV_ISOR2   )   =  -1.0   ! SHort-lived
!DSGC!!bc2xn_adv(IBC_HCOHCO  ,IXADV_HCOHCO  )   =  -1.0   ! Excluded
!DSGC!!bc2xn_adv(IBC_CH3X    ,IXADV_CH3X    )   =  -1.0   ! ??
!DSGC!!bc2xn_adv(IBC_NO3     ,IXADV_NO3     )   =  -1.0   ! SHort-lived
!DSGC!!bc2xn_adv(IBC_N2O5    ,IXADV_N2O5    )   =   1.0   ! jej - 000927
!DSGC!!bc2xn_adv(IBC_C3H7O2  ,IXADV_C3H7O2  )   =   1.0
!DSGC!!bc2xn_adv(IBC_ACETONE ,IXADV_ACETON  )   =   1.0
!DSGC!!bc2xn_adv(IBC_CH3COD  ,IXADV_CH3COD  )   =  -1.0   ! ??
!DSGC!!bc2xn_adv(IBC_NOZ     ,IXADV_NOZ     )   =  -1.0   ! ???
!DSGC!!bc2xn_adv(IBC_CH3O2   ,IXADV_CH3O2   )   =   Short-lived
!DSGC!!bc2xn_adv(IBC_C2H5O2  ,IXADV_C2H5O2  )   =   Short-lived
!DSGC!!bc2xn_adv(IBC_C4H9O2  ,IXADV_C4H9O2  )   =   Short-lived
!DSGC!!bc2xn_adv(IBC_C6H13O2 ,IXADV_C6H13O2 )   =   Short-lived
!DSGC!!bc2xn_adv(IBC_O3P     ,IXADV_O3P     )   =  -1.0   ! Short-lived
!DSGC!!bc2xn_adv(IBC_O1D     ,IXADV_O1D     )   =  -1.0   ! Short-lived
!DSGC!!bc2xn_adv(IBC_OH      ,IXADV_OH      )   =  -1.0   ! Short-lived
!DSGC!!bc2xn_adv(IBC_O3NO    ,IXADV_O3NO    )   =  -1.0   ! Excluded
!DSGC!!bc2xn_adv(IBC_DMS     ,IXADV_DMS     )   =  -1.0   ! Query ????
 !<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
