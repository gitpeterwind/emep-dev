...
module C3PO_Datafile
  ...
  contains
    ...
    procedure   ::                   C3PO_Datafile_Get_Var_r_2d
    ...
    generic     ::  Get_Var       => C3PO_Datafile_Get_Var_i_2d, &
                                     C3PO_Datafile_Get_Var_r_1d, &
                                     C3PO_Datafile_Get_Var_r_2d, &
...
contains
  ...
  !
  ! Useful if only dimension length is needed, and no coordinate values.
  !

  subroutine C3PO_Datafile_Get_Dim( self, name, status, n )
    ...
    character(len=*), parameter  ::  rname = mname//'/C3PO_Datafile_Get_Dim'
  ...
  subroutine C3PO_Datafile_Get_Var_r_1d( self, name, field, units, status, &
                                          fill_value, start, count )
    ...
    character(len=*), parameter  ::  rname = mname//'/C3PO_Datafile_Get_Var_r_1d'
  ...
  end subroutine C3PO_Datafile_Get_Var_r_1d


  ! ***


  subroutine C3PO_Datafile_Get_Var_r_2d( self, name, field, units, status, &
                                          fill_value, start, count )
    ...
    character(len=*), parameter  ::  rname = mname//'/C3PO_Datafile_Get_Var_r_2d'
  ...
  end subroutine C3PO_Datafile_Get_Var_r_2d
