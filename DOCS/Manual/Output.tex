...
\COMMENT{I removed the Base.sites.tgz, Base.sondes.tgz - not part
of modrun.sh. Also eulmod.res and Base\_inst - seems not to be used these days}
...
\COMMENT{This section is more about inputs than outputs. Could be moved ealier?}
...
followed by a list of the stations. For example, a sondes.dat \NEW{input} file
may look like this:
