c "Fake" routine to avoid the use of mpi routines.
c can be used for one processor runs
c replace gc_com.f with this file and 
c remove the preprocessing from the Makefile
c NB: test version, NOT systematically checked!
c Peter 29/10-2004
c
c
...
C
C-------------------------------------------------------------------------------
C $Id: gc_com_for_1_proc.f,v 1.1 2004-10-29 08:47:17 mifapw Exp $
