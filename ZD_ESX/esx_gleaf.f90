...
module esx_gleaf
  ...
  use DO3SE_Gsto_ml
  use DO3SE_Photosynthesis_ml, only: DO3SE_gsto_pn => gsto_pn, &
                                     PnGstoConfig_t, &
                                     check_PnGstoConfig
  use DO3SE_SMD_ml, only: SMDConfig_t, SMDData_t, check_SMDConfig, soil_moisture_from_SWC
  use DO3SE_Util_ml, only: DO3SE_assert_sub => assert, &
                           DO3SE_assert_not_sub => assert_not, &
                           DO3SE_inverted_assert_not => inverted_assert_not
...
contains
  ...
  subroutine config_DO3SE()
    ...
    DO3SE_assert_sub => DO3SE_inverted_assert_not
    DO3SE_assert_not_sub => CheckStop_TF
  ...
  subroutine DO3SE_gleaf()
    ...
    do iz = esx%nhVeg, 1, -1
      associate (gp => gsto_params(iz), &
        ...
        case ("photosynthesis")
          gp%gmax = DO3SE_gsto_pn(pn_conf, met%tzC, met%tleafC, met%uz, &
