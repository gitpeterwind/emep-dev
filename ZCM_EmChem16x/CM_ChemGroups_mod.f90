...
module ChemGroups_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemGroups = " EmChem16x ShipNOx BVOC_EmChem16x Aero2017nx VBS_acp2012 FFireInert SeaSalt DustExtended"
  
  
  ! Assignment of groups from GenIn_Species.csv
  public :: Init_ChemGroups
  
  type(typ_sp), dimension(136), public, save :: chemgroups
