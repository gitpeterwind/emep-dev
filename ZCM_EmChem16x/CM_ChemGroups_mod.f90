...
module ChemGroups_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemGroups = " EmChem16 ShipNOx Aero2017nx VBS_acp2012 FFireInert SeaSalt Dust"
  
  
  ! Assignment of groups from GenIn_Species.csv
  public :: Init_ChemGroups
  
  type(typ_sp), dimension(123), public, save :: chemgroups
  ...
  character(len=TXTLEN_SHORT), public, target, save, dimension (14) :: &
    ...
    "SO4", "NO3f", "NO3c", "NH4f", "ECn", "ECa", "EC",  &
      "ECn", "ECa", "EC", "DDf", "DDc", "EC", "DDf"  &
    ]
