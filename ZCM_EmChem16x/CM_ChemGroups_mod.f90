...
module ChemGroups_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemGroups = " EmChem16x ShipNOx BVOC_EmChem16x Aqueous_EmChem16x Aero2017nx VBS_acp2012 FFireInert SeaSalt DustExtended Ash_EmChem16x"
  ...
  integer, public, target, save, dimension (6) :: &
    BVOC_GROUP = (/ C5H8, APINENE, MVK, BPINENE, XTERP, SQT_SOA_NV /)
  
  integer, public, target, save, dimension (4) :: &
    MONOTERP_GROUP = (/ APINENE, BPINENE, XTERP, SQT_SOA_NV /)
...
contains
  ...
  subroutine Init_ChemGroups()
    ...
    chemgroups(45)%name="OM25"
    chemgroups(45)%specs=>OM25_GROUP
    
    chemgroups(46)%name="WDEP_OM25"
    chemgroups(46)%specs=>WDEP_OM25_GROUP
    
    chemgroups(47)%name="DDEP_OM25"
    chemgroups(47)%specs=>DDEP_OM25_GROUP
    
    chemgroups(48)%name="PCM"
    chemgroups(48)%specs=>PCM_GROUP
    
    chemgroups(49)%name="WDEP_PCM"
    chemgroups(49)%specs=>WDEP_PCM_GROUP
    
    chemgroups(50)%name="DDEP_PCM"
    chemgroups(50)%specs=>DDEP_PCM_GROUP
    
    chemgroups(51)%name="PPM25"
    chemgroups(51)%specs=>PPM25_GROUP
    
    chemgroups(52)%name="WDEP_PPM25"
    chemgroups(52)%specs=>WDEP_PPM25_GROUP
    
    chemgroups(53)%name="DDEP_PPM25"
    chemgroups(53)%specs=>DDEP_PPM25_GROUP
    
    chemgroups(54)%name="PPM10"
    chemgroups(54)%specs=>PPM10_GROUP
    
    chemgroups(55)%name="WDEP_PPM10"
    chemgroups(55)%specs=>WDEP_PPM10_GROUP
    
    chemgroups(56)%name="DDEP_PPM10"
    chemgroups(56)%specs=>DDEP_PPM10_GROUP
    
    chemgroups(57)%name="NVWOODOC25"
    chemgroups(57)%specs=>NVWOODOC25_GROUP
    ...
    chemgroups(60)%name="NONVOLPCM"
    chemgroups(60)%specs=>NONVOLPCM_GROUP
    
    chemgroups(61)%name="WDEP_NONVOLPCM"
    chemgroups(61)%specs=>WDEP_NONVOLPCM_GROUP
    
    chemgroups(62)%name="DDEP_NONVOLPCM"
    chemgroups(62)%specs=>DDEP_NONVOLPCM_GROUP
    
    chemgroups(63)%name="NVABSOM"
    chemgroups(63)%specs=>NVABSOM_GROUP
    
    chemgroups(64)%name="WDEP_NVABSOM"
    chemgroups(64)%specs=>WDEP_NVABSOM_GROUP
    
    chemgroups(65)%name="DDEP_NVABSOM"
    chemgroups(65)%specs=>DDEP_NVABSOM_GROUP
    
    chemgroups(66)%name="NVFFUELOC25"
    chemgroups(66)%specs=>NVFFUELOC25_GROUP
    
    chemgroups(67)%name="WDEP_NVFFUELOC25"
    chemgroups(67)%specs=>WDEP_NVFFUELOC25_GROUP
    
    chemgroups(68)%name="DDEP_NVFFUELOC25"
    chemgroups(68)%specs=>DDEP_NVFFUELOC25_GROUP
    
    chemgroups(69)%name="PPM_C"
    chemgroups(69)%specs=>PPM_C_GROUP
    
    chemgroups(70)%name="WDEP_PPM_c"
    chemgroups(70)%specs=>WDEP_PPM_c_GROUP
    
    chemgroups(71)%name="DDEP_PPM_c"
    chemgroups(71)%specs=>DDEP_PPM_c_GROUP
    
    chemgroups(72)%name="PM10ANTHR"
    chemgroups(72)%specs=>PM10ANTHR_GROUP
    
    chemgroups(73)%name="WDEP_PM10anthr"
    chemgroups(73)%specs=>WDEP_PM10anthr_GROUP
    
    chemgroups(74)%name="DDEP_PM10anthr"
    chemgroups(74)%specs=>DDEP_PM10anthr_GROUP
    
    chemgroups(75)%name="NVFFUELOC_COARSE"
    chemgroups(75)%specs=>NVFFUELOC_COARSE_GROUP
    
    chemgroups(76)%name="WDEP_NVFFUELOC_COARSE"
    chemgroups(76)%specs=>WDEP_NVFFUELOC_COARSE_GROUP
    
    chemgroups(77)%name="DDEP_NVFFUELOC_COARSE"
    chemgroups(77)%specs=>DDEP_NVFFUELOC_COARSE_GROUP
    
    chemgroups(78)%name="OMCOARSE"
    chemgroups(78)%specs=>OMCOARSE_GROUP
    
    chemgroups(79)%name="WDEP_OMCOARSE"
    chemgroups(79)%specs=>WDEP_OMCOARSE_GROUP
    
    chemgroups(80)%name="DDEP_OMCOARSE"
    chemgroups(80)%specs=>DDEP_OMCOARSE_GROUP
    
    chemgroups(81)%name="EC_F"
    chemgroups(81)%specs=>EC_F_GROUP
    
    chemgroups(82)%name="WDEP_EC_f"
    chemgroups(82)%specs=>WDEP_EC_f_GROUP
    
    chemgroups(83)%name="DDEP_EC_f"
    chemgroups(83)%specs=>DDEP_EC_f_GROUP
    
    chemgroups(84)%name="WOODEC"
    chemgroups(84)%specs=>WOODEC_GROUP
    
    chemgroups(85)%name="WDEP_WOODEC"
    chemgroups(85)%specs=>WDEP_WOODEC_GROUP
    
    chemgroups(86)%name="DDEP_WOODEC"
    chemgroups(86)%specs=>DDEP_WOODEC_GROUP
    
    chemgroups(87)%name="ECFINE"
    chemgroups(87)%specs=>ECFINE_GROUP
    
    chemgroups(88)%name="WDEP_ECFINE"
    chemgroups(88)%specs=>WDEP_ECFINE_GROUP
    
    chemgroups(89)%name="DDEP_ECFINE"
    chemgroups(89)%specs=>DDEP_ECFINE_GROUP
    
    chemgroups(90)%name="ECCOARSE"
    chemgroups(90)%specs=>ECCOARSE_GROUP
    
    chemgroups(91)%name="WDEP_ECCOARSE"
    chemgroups(91)%specs=>WDEP_ECCOARSE_GROUP
    
    chemgroups(92)%name="DDEP_ECCOARSE"
    chemgroups(92)%specs=>DDEP_ECCOARSE_GROUP
    
    chemgroups(93)%name="FFUELEC"
    chemgroups(93)%specs=>FFUELEC_GROUP
    
    chemgroups(94)%name="WDEP_FFUELEC"
    chemgroups(94)%specs=>WDEP_FFUELEC_GROUP
    
    chemgroups(95)%name="DDEP_FFUELEC"
    chemgroups(95)%specs=>DDEP_FFUELEC_GROUP
    
    chemgroups(96)%name="OC"
    chemgroups(96)%specs=>OC_GROUP
    
    chemgroups(97)%name="ASOA"
    chemgroups(97)%specs=>ASOA_GROUP
    
    chemgroups(98)%name="WDEP_ASOA"
    chemgroups(98)%specs=>WDEP_ASOA_GROUP
    
    chemgroups(99)%name="DDEP_ASOA"
    chemgroups(99)%specs=>DDEP_ASOA_GROUP
    
    chemgroups(100)%name="BSOA"
    chemgroups(100)%specs=>BSOA_GROUP
    
    chemgroups(101)%name="WDEP_BSOA"
    chemgroups(101)%specs=>WDEP_BSOA_GROUP
    
    chemgroups(102)%name="DDEP_BSOA"
    chemgroups(102)%specs=>DDEP_BSOA_GROUP
    
    chemgroups(103)%name="PFFUELOA25"
    chemgroups(103)%specs=>PFFUELOA25_GROUP
    
    chemgroups(104)%name="WDEP_PFFUELOA25"
    chemgroups(104)%specs=>WDEP_PFFUELOA25_GROUP
    
    chemgroups(105)%name="SVFFUELOA25"
    chemgroups(105)%specs=>SVFFUELOA25_GROUP
    
    chemgroups(106)%name="WDEP_SVFFUELOA25"
    chemgroups(106)%specs=>WDEP_SVFFUELOA25_GROUP
    
    chemgroups(107)%name="PWOODOA25"
    chemgroups(107)%specs=>PWOODOA25_GROUP
    
    chemgroups(108)%name="WDEP_PWOODOA25"
    chemgroups(108)%specs=>WDEP_PWOODOA25_GROUP
    
    chemgroups(109)%name="SVWOODOA25"
    chemgroups(109)%specs=>SVWOODOA25_GROUP
    
    chemgroups(110)%name="WDEP_SVWOODOA25"
    chemgroups(110)%specs=>WDEP_SVWOODOA25_GROUP
    
    chemgroups(111)%name="TRACER"
    chemgroups(111)%specs=>TRACER_GROUP
    
    chemgroups(112)%name="WDEP_OC"
    chemgroups(112)%specs=>WDEP_OC_GROUP
    
    chemgroups(113)%name="DDEP_OC"
    chemgroups(113)%specs=>DDEP_OC_GROUP
    
    chemgroups(114)%name="PPM25_FIRE"
    chemgroups(114)%specs=>PPM25_FIRE_GROUP
    
    chemgroups(115)%name="WDEP_PPM25_FIRE"
    chemgroups(115)%specs=>WDEP_PPM25_FIRE_GROUP
    
    chemgroups(116)%name="DDEP_PPM25_FIRE"
    chemgroups(116)%specs=>DDEP_PPM25_FIRE_GROUP
    
    chemgroups(117)%name="NVFFIREOC25"
    chemgroups(117)%specs=>NVFFIREOC25_GROUP
    
    chemgroups(118)%name="WDEP_NVFFIREOC25"
    chemgroups(118)%specs=>WDEP_NVFFIREOC25_GROUP
    
    chemgroups(119)%name="DDEP_NVFFIREOC25"
    chemgroups(119)%specs=>DDEP_NVFFIREOC25_GROUP
    
    chemgroups(120)%name="FFIREBC"
    chemgroups(120)%specs=>FFIREBC_GROUP
    
    chemgroups(121)%name="WDEP_FFIREBC"
    chemgroups(121)%specs=>WDEP_FFIREBC_GROUP
    
    chemgroups(122)%name="DDEP_FFIREBC"
    chemgroups(122)%specs=>DDEP_FFIREBC_GROUP
    
    chemgroups(123)%name="SS"
    chemgroups(123)%specs=>SS_GROUP
    
    chemgroups(124)%name="WDEP_SS"
    chemgroups(124)%specs=>WDEP_SS_GROUP
    
    chemgroups(125)%name="DDEP_SS"
    chemgroups(125)%specs=>DDEP_SS_GROUP
    
    chemgroups(126)%name="DUST"
    chemgroups(126)%specs=>DUST_GROUP
    
    chemgroups(127)%name="WDEP_DUST"
    chemgroups(127)%specs=>WDEP_DUST_GROUP
    
    chemgroups(128)%name="DDEP_DUST"
    chemgroups(128)%specs=>DDEP_DUST_GROUP
    
    chemgroups(129)%name="DUST_ANT_F"
    chemgroups(129)%specs=>DUST_ANT_F_GROUP
    
    chemgroups(130)%name="WDEP_DUST_ANT_F"
    chemgroups(130)%specs=>WDEP_DUST_ANT_F_GROUP
    
    chemgroups(131)%name="DDEP_DUST_ANT_F"
    chemgroups(131)%specs=>DDEP_DUST_ANT_F_GROUP
    
    chemgroups(132)%name="DUST_ANT_C"
    chemgroups(132)%specs=>DUST_ANT_C_GROUP
    
    chemgroups(133)%name="WDEP_DUST_ANT_C"
    chemgroups(133)%specs=>WDEP_DUST_ANT_C_GROUP
    
    chemgroups(134)%name="DDEP_DUST_ANT_C"
    chemgroups(134)%specs=>DDEP_DUST_ANT_C_GROUP
    
    chemgroups(135)%name="DUST_NAT_F"
    chemgroups(135)%specs=>DUST_NAT_F_GROUP
    
    chemgroups(136)%name="WDEP_DUST_NAT_F"
    chemgroups(136)%specs=>WDEP_DUST_NAT_F_GROUP
    
    chemgroups(137)%name="DDEP_DUST_NAT_F"
    chemgroups(137)%specs=>DDEP_DUST_NAT_F_GROUP
    
    chemgroups(138)%name="DUST_NAT_C"
    chemgroups(138)%specs=>DUST_NAT_C_GROUP
    
    chemgroups(139)%name="WDEP_DUST_NAT_C"
    chemgroups(139)%specs=>WDEP_DUST_NAT_C_GROUP
    
    chemgroups(140)%name="DDEP_DUST_NAT_C"
    chemgroups(140)%specs=>DDEP_DUST_NAT_C_GROUP
    
    chemgroups(141)%name="ASH"
    chemgroups(141)%specs=>ASH_GROUP
    
    chemgroups(142)%name="WDEP_ASH"
    chemgroups(142)%specs=>WDEP_ASH_GROUP
    
    chemgroups(143)%name="DDEP_ASH"
    chemgroups(143)%specs=>DDEP_ASH_GROUP
