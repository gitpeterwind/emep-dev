...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChem16x ShipNOx BVOC_EmChem16x Ash_EmChem16x Aqueous_EmChem16x Aero2017nx VBS_acp2012 FFireInert SeaSalt DustExtended"
  ...
  integer, public, parameter :: &
    ...
    , IXADV_Ash_c       =  93  &
    , IXADV_POM_f_WOOD  =  94  &
    , IXADV_POM_f_FFUEL =  95  &
    , IXADV_POM_c_FFUEL =  96  &
    , IXADV_EC_f_WOOD_new=  97  &
    , IXADV_EC_f_WOOD_age=  98  &
    , IXADV_EC_c_WOOD   =  99  &
    , IXADV_EC_f_FFUEL_new= 100
  
  integer, public, parameter :: &
      IXADV_EC_f_FFUEL_age= 101  &
    , IXADV_EC_c_FFUEL  = 102  &
    , IXADV_REMPPM25    = 103  &
    , IXADV_REMPPM_c    = 104  &
    , IXADV_OM25_BGND   = 105  &
    , IXADV_OM25_p      = 106  &
