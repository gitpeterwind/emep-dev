...
module ChemSpecs_mod
  ...
  implicit none
  private
  character(len=*),parameter, public :: CM_schemes_ChemSpecs = " EmChemTest TestX VBS_acp2012 Tracers"
  ...
  integer, public, parameter :: &
      NON_C_ASOA_ug10= 101  &
    , NON_C_ASOA_ug1e2= 102  &
    , NON_C_ASOA_ug1e3= 103  &
    , BSOC_ng100  = 104  &
    , BSOC_ug1    = 105  &
    , BSOC_ug10   = 106  &
    , BSOC_ug1e2  = 107  &
    , BSOC_ug1e3  = 108  &
    , NON_C_BSOA_ng100= 109  &
    , NON_C_BSOA_ug1= 110
  
  integer, public, parameter :: &
      NON_C_BSOA_ug10= 111  &
    , NON_C_BSOA_ug1e2= 112  &
    , NON_C_BSOA_ug1e3= 113  &
    , FFFUEL_ng10 = 114  &
    , WOODOA_ng10 = 115  &
    , FFIREOA_ng10= 116  &
    , SO4         = 117  &
  ...
  integer, public, parameter :: &
      IXADV_newC5H8     =  71  &
    , IXADV_newBVOCTEST =  72  &
    , IXADV_POM_f_WOOD  =  73  &
    , IXADV_POM_f_FFUEL =  74  &
    , IXADV_POM_c_FFUEL =  75  &
    , IXADV_EC_f_WOOD_new=  76  &
    , IXADV_EC_f_WOOD_age=  77  &
    , IXADV_EC_c_WOOD   =  78  &
    , IXADV_EC_f_FFUEL_new=  79  &
    , IXADV_EC_f_FFUEL_age=  80
  ...
  integer, public, parameter :: &
    ...
    , IXADV_ASOC_ug1e2  =  94  &
    , IXADV_ASOC_ug1e3  =  95  &
    , IXADV_NON_C_ASOA_ng100=  96  &
    , IXADV_NON_C_ASOA_ug1=  97  &
    , IXADV_NON_C_ASOA_ug10=  98  &
    , IXADV_NON_C_ASOA_ug1e2=  99  &
    , IXADV_NON_C_ASOA_ug1e3= 100
  
  integer, public, parameter :: &
      IXADV_BSOC_ng100  = 101  &
    , IXADV_BSOC_ug1    = 102  &
    , IXADV_BSOC_ug10   = 103  &
    , IXADV_BSOC_ug1e2  = 104  &
    , IXADV_BSOC_ug1e3  = 105  &
    , IXADV_NON_C_BSOA_ng100= 106  &
    , IXADV_NON_C_BSOA_ug1= 107  &
    , IXADV_NON_C_BSOA_ug10= 108  &
    , IXADV_NON_C_BSOA_ug1e2= 109  &
    , IXADV_NON_C_BSOA_ug1e3= 110
  
  integer, public, parameter :: &
      IXADV_FFFUEL_ng10 = 111  &
    , IXADV_WOODOA_ng10 = 112  &
    , IXADV_FFIREOA_ng10= 113  &
    , IXADV_SO4         = 114  &
    , IXADV_NH3         = 115  &
    , IXADV_NO3_f       = 116  &
    , IXADV_NO3_c       = 117  &
  ...
  integer, public, parameter :: FIRST_SEMIVOL=94, &
                                 LAST_SEMIVOL=116
...
contains
  subroutine define_chemicals()
    ...
    species(newC5H8     ) = Chemical("newC5H8     ",  68.0000,  1,   5.0000,   0.0000,   0.0000 )
    species(newBVOCTEST ) = Chemical("newBVOCTEST ", 136.0000,  1,  10.0000,   0.0000,   0.0000 )
    ...
    species(FFIREOA_ng10) = Chemical("FFIREOA_ng10",  20.4000,  0,   1.0000,   0.0000,   0.0000 )
